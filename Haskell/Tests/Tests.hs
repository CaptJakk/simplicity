...
import qualified Simplicity.BitMachine.StaticAnalysis.Tests
                                               as StaticAnalysis
import qualified Simplicity.BitMachine.Tests   as BitMachine
import qualified Simplicity.Bitcoin.Serialization.Tests
                                               as Serialization
import qualified Simplicity.Elements.Tests     as Elements
import qualified Simplicity.Jets.Tests         as Jets
